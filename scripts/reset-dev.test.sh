...
mkdir -p "$state1/repos/demo" "$state1/tmp" "$state1/recovery" "$state1/adding"
printf 'x' >"$state1/adding/demo"
...
mkdir -p "$home1/Library/Caches/dev.dinhanhthi.dotlore" "$home1/Library/Preferences"
printf 'x' >"$home1/Library/Preferences/dev.dinhanhthi.dotlore.plist"
...
assert_file "$state1/adding/demo"
assert_file "$cloud1/dotlore/demo/manifest.json"
assert_file "$home1/Library/WebKit/dotlore/localstorage"
assert_file "$home1/Library/Caches/dev.dinhanhthi.dotlore"
assert_file "$home1/Library/Preferences/dev.dinhanhthi.dotlore.plist"
...
assert_mentions "$out1" "$state1/adding"
assert_mentions "$out1" "$home1/Library/WebKit/dotlore"
assert_mentions "$out1" "$home1/Library/Caches/dev.dinhanhthi.dotlore"
assert_mentions "$out1" "$home1/Library/Preferences/dev.dinhanhthi.dotlore.plist"
...
assert_gone "$state1/adding"
assert_gone "$home1/Library/Caches/dev.dinhanhthi.dotlore"
assert_gone "$home1/Library/Preferences/dev.dinhanhthi.dotlore.plist"
